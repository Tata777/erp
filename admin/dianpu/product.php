<?php
	...
	$strSQL = "SELECT * FROM `".con_strPREFIX."sys_dianpu` WHERE SysProductsID = ".$strID." LIMIT 1";
	$objDb->query($strSQL);
...
<title><?php echo $strOperation; ?>店铺</title>
...
<table summary="" id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		<td><h1><?php echo $strOperation; ?>店铺</h1></td>
		<td class="actions">
			<table summary="" cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
          <td class="active"><a href="#" ><?php echo $strOperation; ?>店铺</a></td>
...
<table width="100%">
  <tr>
  	<td>
      <div id="listtab">
        <div class="listtab" id="div_1"><a href="#" onclick="ShowSort(1);return false;" class="active"><img src="../images/icon_folder.gif" align="absmiddle">　发布店铺</a></div>
...
<table cellspacing="0" cellpadding="0" width="100%"  class="maintable">
  ...
  <tr id="infoTitleTr">
    <th><span id="p_name">店铺名称</span></th>
    <td>
      <input type="text" name="ProductName" id="ProductName" size="60" value="<?php echo $ProResult['ProductName']; ?>" /> <span>*</span>
    </td>
  </tr>
  <tr  >
    <th><span id="p_subname">店铺地址</span></th>
    <td><input type="text" name="SubName"   id="SubName" size="100"  value="<?php echo $ProResult['SubName']; ?>" />
     </td>
  </tr>
  <tr>
    <th>店铺图片1</th>
  ...
  <tr  >
	...
	<tr  style="display:none;">
		<th><span id="p_price">店铺价格</span></th>
		<td><input name="Price" type="text" id="Price" size="60" value="<?php echo $ProResult['Price']; ?>" /></td>
	</tr>
	<tr >
	  <th>联系方式</th>
	  <td> 
	  <textarea name="Color" id="Color"><?=$ProResult['Color']?></textarea>
	  </td>
	  </tr>
 <tr >
      <th width="20%">店内商品</th>
      <td width="82%">
	   <textarea name="Unit" id="Unit"><?=$ProResult['Unit']?></textarea>
	   </td>
  </tr>    
  <tr  >
    <th>工作时间</th>
    <td> 
	  ...
	  <textarea name="Size" id="Size"><?=$ProResult['Size']?></textarea>
