...
$page = new ShowPage;
$page->PageSize = 20;
$totalnumsql = "select * from hy_member_stock where customer like '%".$customer."%' order by id";
$db->query($totalnumsql);
$recordcount = $db->get_num1();
$page->Total = $recordcount;
$sql = "select * from hy_member_stock where customer like '%".$customer."%' order by id desc limit ".$page->OffSet();
$db->query($sql);
			  ...
			  ?>
			   ...
			   ?>
                  ...
                  <td width="13%" align="center">
					...
					<input name="customer" type="hidden"  size="20" value="<?=$customer;?>">
				  </td>
                </tr>
				  <?
			           }
