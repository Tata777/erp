...
<table summary="" id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    ...
    <td width="77%" class="actions"><table summary="" cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
					<td><a href="banner_index.php">浏览广告</a><a href="down_index.php" class="view"></a></td>
					<td class="active"><a href="banner_advsearch.php">高级搜索</a></td>
				</tr>
			</table>&nbsp;</td>
  </tr>
</table>
<form id="advsearch" name="advsearch" method="post" action="banner_index.php">
  <table cellspacing="0" cellpadding="0" width="100%"  class="maintable" id="feedbackTable">
    ...
    <tr>
      ...
      <td><select name="Field[]" size="10" multiple="multiple" id="select">
            ...
            <option value='ProductName'  >文件名称</option>
  		  
            <option value='Tag'>关键字</option>

            <option value='Note'>下载介绍</option>
