    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _getTreeHTMLByData: function (data, outlineLevel, isLast, isExpand)
        {
            ...
            for (var i = 0; i < data.length; i++)
            {
				...
				isOne && treehtmlarr.push('l-one ');
				isTwo && treehtmlarr.push('l-two ');
				isThree && treehtmlarr.push('l-three ');
				isFour && treehtmlarr.push('l-four ');
				isFive && treehtmlarr.push('l-five ');
				isSix && treehtmlarr.push('l-six ');
				isSeven && treehtmlarr.push('l-seven ');
