...
<br>
  ...
  <form name="ad" enctype="multipart/form-data" method="post" action="downloadfile_save.php" onSubmit="return check();">
    <tr>
      <td height="31" colspan="2" > <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr class="bgtitle">
                        <td height="30"><table width="100%" height="24" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="175"><div align="center"><strong><img src="../images/ad.jpg"> 下 载 文 件 添 加</strong></div></td>
    ...
    <tr>
      ...
      <td><input type="text" name="download_name" size="50"></td>
    </tr>
    <tr style="display:none;">
      <td width="287" height="30">下载类别选择：<font color="#FF0000">*</font></td>
      <td width="700"><select name="downloadsort">
	   <option value="-1">--请选择下载类别--</option>
	  <? for ($z=0;$z<$downloadsortnum;$z++){?>
        <option value=<? echo $downloadsortresult[$z]['downloadsort_id'];?>><? echo $downloadsortresult[$z]['downloadsort_name'];?></option>
           <? }?>
      </select>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
    <tr style="display:none;">
      ...
      <td height="30"><input type="radio" name="file_member" value="1">
是
  <input name="file_member" type="radio" value="0" checked>
不是</td>
    </tr>
    <tr>
      <td height="30">文件内容(允许上传小于2M的RAR,ZIP,JPG,GIF格式)<font color="#FF0000">*</font>
      </td>
      <td height="30"> <input name="pic_url" id="pic_url" type="text"  size="30">
        ...
        文件大小（kb）：
        <input type="text" name="downloadfile_size" id="downloadfile_size"></td>
    </tr>
    <tr>
      <td height="30" >下载内容简介：</td>
      <td height="30" ><textarea name="download_content" cols="50" rows="6"></textarea></td>
    </tr>
    <tr>
