...
<span>宽高48*48，ICO图片后缀必须为.ico在网页上才能正常显示</span>	</td>
  ...
  <!--
  <tr >
    <th>汇率(exchange rate)</th>
    <td>
      <label>
        <input name="exchange" type="text" id="exchange" style="width:300px;" value="<?php echo $RightResult['exchange']?>" />
      </label>		</td>
  </tr>
    ...
    <td>
      <label>
        <input name="KING" type="text" id="KING" style="width:300px;" value="<?php echo $RightResult['KING']?>" />
      </label>		</td>
  </tr>
    ...
    <td>
 	<label>
      <input type="radio" name="PT" value="1"  <?php if($RightResult['PT'] == 1){?> checked="checked" <? }?>/>是
	        <input type="radio" name="PT" value="2" <?php if($RightResult['PT'] == 2){?> checked="checked" <? }?> />否
      </label></td>
  </tr>
 -->
  <tr >
    ...
    <tr>
        <th>地址</th>
        <td><input name="address" type="text" id="address" size="60" value="<?php echo $RightResult['address'];?>" /> </td>
    </tr>

    <tr>
        <th>咨询电话</th>
        <td><input name="phone" type="text" id="phone" size="60" value="<?php echo $RightResult['phone'];?>" /> </td>
    </tr>

    <tr>
        <th>传真</th>
        <td><input name="fax" type="text" id="fax" size="60" value="<?php echo $RightResult['fax'];?>" /> </td>
    </tr>
    <tr>
        <th>邮箱</th>
        <td><input name="email" type="text" id="email" size="60" value="<?php echo $RightResult['email'];?>" /> </td>
    </tr>
