...
调用
<select onchange="initcity();" name="CmpProvince">
...
function creatprovince(CmpProvince){
	...
	for(var i = 0; i < provinces.length; i++) {
	    document.memberadd["CmpProvince"].options[i+1]=new Option(provinces[i],provinces[i]);
...
function city_info(){
	var bb = citys +  document.memberadd["CmpCity"].value + '市';
	document.getElementById("citypr_info").innerHTML = bb ; 
