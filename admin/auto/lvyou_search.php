    ...
    <tr>
        ...
        <td width="77%" class="actions"><table summary="" cellpadding="0" cellspacing="0" border="0" align="right">
                <tr>
					...
					<td   class="active"><a href="lvyou_search.php" class="edit">高级搜索</a></td>
...
<form method="get" name="searchfrom" id="searchfrom" action="lvyou_admin_list.php" >
<tr><td align="right"><label><b>序号</b></label></td><td><input type="text" name="id" id="id" /></td></tr>
<tr><td align="right"><label><b>到达地点</b></label></td><td><input type="text" name="arrivePlace" id="arrivePlace" /></td></tr>
