...
/*	include_once(CFG_LIB_DIR.'generic.lib.php');
	...
	$RelationID = $objRelation->strGetRelationID($Tag, con_strPREFIX."sys_products", "SysProductsID", "Tag", $_GET['id']);
	$Price = $Price ? $Price : "0";
