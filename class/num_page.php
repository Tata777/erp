<?php
	...
	DIV.scott SPAN.disabled {
	 ...
	 <div class=\"scott\">
		";
	  $curPage!=1?$pageStr.="<a href=?curPage=1&$pagePara> 上一页 </a>":$pageStr.="<a href='javascript:void(0);'> 上一页</a>";
	 for($i=$pageFromNum;$i<=$pageToNum;$i++){
		$curPage==$i ? $pageStr.="<span class='current'>$i</span>" : 
		$pageStr.="<a href=?curPage=$i&$pagePara>$i</a>";
	  }  
		$curPage!=$pageCount ? $pageStr.="<a href=?curPage=$nextPage&$pagePara> 下一页</a>" : 
