...
/*	include_once(CFG_LIB_DIR.'generic.lib.php');
	...
	switch($_GET['act'])
	{
		...
		case "update":
			$strID = $_GET['id'];
			$strSQL = "UPDATE `".con_strPREFIX."zfresult` SET `guest_re` = '$guest_re', `guest_redate` = '$date' WHERE guest_id = ".$strID;
			/*echo $strSQL;
			exit;*/
			$objAddModify->vodExecute("modify", $strSQL, "index2.php?act=update&id=".$strID);
			break;	
	}
