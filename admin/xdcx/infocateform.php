...
$objSort = new clsCategoryAct('infocategory', 'info', 'CateID', 'InfoCategoryID', 'infocateform.php');
...
<table summary="" id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td width="23%"><h1><?php echo (isset($_GET['InfoCategoryID'])&&!empty($_GET['InfoCategoryID'])) ? '编辑' :'添加'?>类别</h1></td>
    <td width="77%" class="actions"><table summary="" cellpadding="0" cellspacing="0" border="0" align="right">
      <tr>
        <td ><a href="infocatelist.php" class="view">浏览分类</a></td>
        <td class="active"><a href="infocateform.php?ParentID=1" class="<?php echo (isset($_GET['InfoCategoryID'])&&!empty($_GET['InfoCategoryID'])) ? 'edit' :'add'?>"><?php echo (isset($_GET['InfoCategoryID'])&&!empty($_GET['InfoCategoryID'])) ? '编辑' :'添加'?>分类</a></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<div class="buttons">
  ...
  <input type="hidden" name="act" id="act" value="<?php echo (isset($_GET['InfoCategoryID'])&&!empty($_GET['InfoCategoryID'])) ? 'edit' :'add'?>" />
  <input name="IsSelect" type="hidden" id="IsSelect" value="InfoCategoryID,ParentID,CateName,CateNameEn,CateNameFn,CustomLink,SortNum,IsLock,Intro,Photo" />
	<input name="IsNum" type="hidden" id="IsNum" value="InfoCategoryID,ParentID,SortNum,IsLock" />
  <?php echo (isset($_GET['InfoCategoryID'])&&!empty($_GET['InfoCategoryID'])) ? '<input name="InfoCategoryID" type="hidden" value="'.$_GET['InfoCategoryID'].'" />' :''?>
