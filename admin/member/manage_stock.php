            ...
            <td width="100%" height="41" valign="top">
              <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#999999" bordercolordark="#FFFFFF" bgcolor="#FFFFFF" class="word">
				...
				<tr >
                  ...
                  <td width="16%" align="center" background="../images/title3.gif"><span class="style1">姓 名</span></td>
                  <td width="11%" align="center" background="../images/title3.gif"><span class="style1">性别</span></td>
                  <td width="20%" align="center" background="../images/title3.gif"><span class="style1">所在城市</span></td>
                  <td width="18%" align="center" background="../images/title3.gif"><span class="style1">电话</span></td>
                  <td width="18%" align="center" background="../images/title3.gif"><span class="style1">客户库存</span></td>
			  ...
			  ?>
			   ...
			   ?>
                  ...
                  <td width="16%" align="center"><? echo $news_result[$i]['user_truename'];?>&nbsp;</td>
                  <td width="11%" align="center"> <? echo $news_result[$i]['user_sex'];?>&nbsp;                  </td>
                  <td width="20%" align="center"> <? echo $news_result[$i]['user_city']; ?></td>
				  
                  <td width="18%" align="center"><? echo $news_result[$i]['user_tel'];?>&nbsp;</td>
                <td width="18%" align="center"><a href="addstock.php">库存添加</a></td>
