...
$objSort = new clsCategoryAct('companycategory', 'member', 'CmpCateID', 'ComCategoryID', 'comcateform.php');
...
<table summary="" id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td width="23%"><h1><?php echo (isset($_GET['ComCategoryID'])&&!empty($_GET['ComCategoryID'])) ? '编辑' :'添加'?>类别</h1></td>
    <td width="77%" class="actions"><table summary="" cellpadding="0" cellspacing="0" border="0" align="right">
      <tr>
        <td ><a href="comcatelist.php" class="view">浏览分类</a></td>
        <td class="active"><a href="comcateform.php?ParentID=1" class="<?php echo (isset($_GET['ComCategoryID'])&&!empty($_GET['ComCategoryID'])) ? 'edit' :'add'?>"><?php echo (isset($_GET['ComCategoryID'])&&!empty($_GET['ComCategoryID'])) ? '编辑' :'添加'?>分类</a></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<div class="buttons">
  ...
  <input type="hidden" name="act" id="act" value="<?php echo (isset($_GET['ComCategoryID'])&&!empty($_GET['ComCategoryID'])) ? 'edit' :'add'?>" />
  <input name="IsSelect" type="hidden" id="IsSelect" value="ComCategoryID,ParentID,CateName,CustomLink,SortNum,IsLock,Intro" />
	<input name="IsNum" type="hidden" id="IsNum" value="ComCategoryID,ParentID,SortNum,IsLock" />
  <?php echo (isset($_GET['ComCategoryID'])&&!empty($_GET['ComCategoryID'])) ? '<input name="ComCategoryID" type="hidden" value="'.$_GET['ComCategoryID'].'" />' :''?>
